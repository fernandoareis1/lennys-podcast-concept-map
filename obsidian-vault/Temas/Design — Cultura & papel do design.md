...
fluxo: Design & UX
---
# 🎭 Tema · Cultura & papel do design

**Fluxo:** [[04 - Design & UX]] · **Camada:** L2 (Tema)

O lugar do design na empresa: parte do **DNA desde o início** ou tratado como "serviço" que pega coisas antes de saírem. Empresa *design-led* ≠ *designer-led*.

## Conceitos (L3)
- [[Design é cultura, não serviço]] — design no DNA, não enxertado depois · **⬇ tem aprofundamento**
- [[Beleza como Funcionalidade e Confiança]] — beleza amplifica funcionalidade e gera confiança; não é superficial — é ROI mensurável (Katie Dill)
- [[Alcançar as Estrelas, Pousar na Lua — Vision Work]] — esboçar o ideal antes de incrementar; sem norte, os incrementos não convergem (Katie Dill)
