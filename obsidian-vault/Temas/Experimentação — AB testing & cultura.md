...
- [[SPACE Framework — Medir Produtividade Além do Output]] — Satisfaction + Performance + Activity + Communication + Efficiency/Flow; Trust emerge como 6ª dimensão na era de IA; não prescritivo, se adapta ao contexto
- [[Métricas como Espelho da Narrativa de Liderança]] — enquadre métricas na linguagem da liderança: market share → velocidade; profit margin → custo economizado; velocity → deployment frequency
