...
- [[Incrementalidade vs. Atribuição — Crédito Real de Paid]] — atribuição diz quem recebeu crédito; incrementalidade (GeoX, Conversion Lift) revela se a conversão teria acontecido sem o anúncio; eBay cortou brand spend após descobrir redundância com orgânico
- [[Goodhart's Law — Métricas como Metas]] — qualquer métrica que vira meta deixa de ser boa métrica; overfitting em ML = Goodhart's Law em negócios; os 80% mais valiosos do espaço de produto são não-quantificáveis (fun, delight)
