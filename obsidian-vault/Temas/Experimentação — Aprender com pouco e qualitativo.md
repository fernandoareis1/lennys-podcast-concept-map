...
- [[Seed Controlado — Eliminar Variáveis Confusas no Teste]] — semeie artificialmente os primeiros 100 usuários para criar densidade e testar produto sem variável confusa de "poucos usuários"; seeding é para testar, não para crescer
