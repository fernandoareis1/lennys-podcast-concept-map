...
- [[Estratégia é Prática, não Talento]] — não existe estrategista natural; todos os grandes praticaram muito; não espere o momento certo para começar
...
- [[Quatro quests de transição de carreira]] — sair / próximo passo / retomar controle / realinhar; identificar a quest certa muda toda a estratégia de busca
...
- [[Alta Agência no PM — Ownership, Execução Criativa e Resiliência]] — encontrar um caminho sem esperar condições perfeitas; ownership + execução criativa + resiliência; principal diferenciador entre PMs que superam e ficam abaixo do potencial
...
- [[3 Armadilhas de Carreira do PM]] — processo sobre progresso, excesso de autocentrismo e não admitir erros; o oposto (followership + clareza + impacto) é o que abre promoções
- [[Aprender IA pelo Fazer — PM Hands-On]] — construir um modelo pequeno hands-on (mesmo com no-code como Google AutoML) cria intuição que leitura não cria; entender quando 70% de acurácia é suficiente muda decisões de produto
- [[Agência Individual para Transformação]] — PMs em feature teams têm mais agência do que imaginam; self-assess, pilot de discovery, skill stack de 4 dimensões (customer/data/business/market); o manager importa mais que a empresa
