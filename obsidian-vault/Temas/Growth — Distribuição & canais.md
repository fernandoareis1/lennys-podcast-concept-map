...
---
# 📡 Tema · Distribuição & canais

**Fluxo:** [[06 - Growth & Aquisição]] · **Camada:** L2 (Tema)

Produto ótimo é necessário, mas **não suficiente** — quem ganha constrói **distribuição**. Onde a próxima onda nasce e como educar o mercado.
...
- [[Canais Earned — Vantagem Estrutural de Growth]] — virality/UGC/referral como ativos que ninguém toma de você
...
- [[Signs of Life Test — Exploração Mínima de Canal]] — teste mínimo com lookalike de 1% ou budget pequeno antes de escalar em canal novo; diagnóstica targeting → criativo → mensagem na sequência certa; "we're either winning or we're learning"
- [[Recomendações Curadas — Loop de Boa Vontade]] — descoberta curada por criadores (não algoritmo); loop de boa vontade viral; 1 em 3 novas inscrições do Substack vem da rede
...
- [[Dummy Explanation — Comunicar Sem Assumir Contexto]] — nunca assuma que o comprador vive na sua bolha; use termos que o cliente busca, não jargão interno; você é o único cansado da mensagem — o cliente está apenas começando a absorvê-la
...
- [[Teach First, Sell Second — Vendedor como Educador]] — quando cold outreach falha, ensine algo útil antes de vender; use dados únicos do seu segmento; Facebook/Glassdoor: report de sentiment = reunião com ELT
...
- [[Contratação do Primeiro Vendedor — Perfil e Timing]] — AE pioneer (não VP), 2 hires mínimo, job simulation escrita (57% desistem); sinais de timing: 20-30% win rate + while loop — founder é o produto em zero-a-um; sales é pesquisa antes de ser receita; não contrate vendedor antes de ~$1M ARR; só o founder vê os "budding moments" que refinam ICP e pitch
