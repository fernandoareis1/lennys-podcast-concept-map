...
- [[Três Níveis de Escuta]] — Nível 1 (interno: distraído por si mesmo), Nível 2 (focado: repete palavras), Nível 3 (global: ouve emoções e o não-dito); grandes líderes operam no Nível 3 ao coachiar, influenciar e vender
- [[NVC — Comunicação Não-Violenta para Conflito]] — Observação + Sentimento + Necessidade + Pedido; meta do conflito = entendimento mútuo, não convencer; "profissionais têm sentimentos — e se ignorados, emergem de forma inconsciente"
