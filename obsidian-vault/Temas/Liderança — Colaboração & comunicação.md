...
---
# 🤝 Tema · Colaboração & comunicação

**Fluxo:** [[09 - Liderança & Times]] · **Camada:** L2 (Tema)

Como o time trabalha junto de verdade: quebrar a cultura de silos e comunicar (sobretudo para cima) de forma que executivos entendam e ajudem.
...
- [[Preparar para ser Espontâneo — Framework de Comunicação sob Pressão]] — mentalidade (conectar > impressionar) + abordagem (escuta ativa) + estrutura (frameworks); preparação libera o cérebro para improvisar melhor
...
- [[Momento dos 5 Segundos — O Núcleo de Toda Boa História]] — toda história é sobre um único instante de transformação ou realização; 98% é contexto que serve ao flash final; comece pelo fim; oposição entre estado inicial e final cria conexão universal
- [[Stakes — 5 Ferramentas para Criar Tensão Sustentada]] — elefante, mochila, migalha de pão, ampulheta e bola de cristal; distribua stakes ao longo da história, não front-loaded; assume 100% do tempo que a audiência não quer ouvir
- [[Adjacência Temática — Contar Outra Coisa para Dizer o que Importa]] — case tema/mensagem com tema/mensagem, não conteúdo com conteúdo; o snap de realização é o momento mais memorável; band-aid (história pontual) vs. tijolos (banco de histórias)
- [[Fight Club — Slot Semanal para Conflitos Inevitáveis]] — 30 min semanais com trio PM+eng+design para resolver conflitos antes que escalem; container seguro para tensão inevitável; relacionamento fora da reunião fica mais saudável porque conflito tem lugar
- [[Show Don't Tell — Tornar o Intangível Visceral]] — mantra do head of design Charlie Sutton (Atlassian); emoção antes de dados; vídeo de usuário antes de slides; em B2B o vídeo traz o usuário para a sala; buy-in via conexão emocional antes da intelectual
- [[Prep Call antes da Apresentação — Feedback como Sinal de Fit]] — revisão do draft de apresentação com candidato antes da rodada final; como incorpora o feedback é o maior sinal de fit; simula o trabalho real; candidato também aprende como é trabalhar com o hiring manager
