...
- [[Cinco Pernas do Banco — Time Cross-Funcional Completo]] — expandir o trio PM+design+eng para incluir research/analytics E marketing como parceiros plenos; PM ainda é o decisor; "você não precisa ter as melhores ideias, mas precisa escolher as melhores ideias"
- [[Full Stack Builder — Time de Produto na Era da IA]] — um builder leva ideia ao lançamento independente de função; 5 habilidades humanas insubstituíveis (visão, empatia, comunicação, criatividade, julgamento); pods que se remontam por quarter; APM→APB; agentes internos (trust, research, growth, analyst)
...
- [[Valores com Honestidade, Aplicabilidade e Reversibilidade]] — 3 testes para um valor útil: honesto (você realmente faz o que afirma), aplicável (orienta decisões reais), reversível (uma empresa poderia dizer o oposto); identity values não filtram nada
- [[CS antes de Sales — Customer Success como Fundação]] — CS antes de sales no Airtable; over-investir num usuário early cria champion multiplicador; loop CS→conteúdo→escala; marketing e CS têm os mesmos objetivos; KPI: quantos usuários foram promovidos usando o produto
