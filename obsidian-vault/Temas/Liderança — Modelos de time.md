...
---
# 🧱 Tema · Modelos de time

**Fluxo:** [[09 - Liderança & Times]] · **Camada:** L2 (Tema)

Como o time de produto se **organiza e decide**: times empoderados que perseguem problemas (não features), o trio que decide junto, e o papel real do PM.

## Conceitos (L3)
- [[Empowered Teams vs Feature Teams]] — problemas a resolver vs roadmap de outputs
- [[Product Trio]] — PM + design + eng decidindo juntos
...
- [[Compressão do Talent Stack por IA]] — ferramentas de IA dissolvem fronteiras entre papéis; cada handoff eliminado = menos ruído organizacional; presença de um papel dedicado previne outros de assumir o ownership daquele domínio · **⬇ tem aprofundamento**
...
- [[Três Pilares do PM Excepcional]] — simplificar, acompanhar resultados, carregar a água; o que separa grandes PMs além das habilidades básicas
...
- [[Valores como Faca Afiada — Reconstrução Cultural]] — valores como ferramenta de seleção, não aspiração; fórmula hard-coded de performance + comportamento; employee-founder-product market fit; 40% turnover → 98-99% aprovação
...
- [[Arquiteto-Otimizador-Escalador — Os Três Tipos de Executivo]] — três arquétipos de executivo por estágio: arquiteto (constrói playbook do zero), otimizador (melhora o existente), escalador (encontra alavancagem); contratar tipo errado para estágio errado é erro fatal
- [[Produto é o Time — Empresa como Produto Principal]] — a empresa é o produto; contratações são lançamentos; heartfelt intensity > habilidade técnica; crédito vai para quem constrói — três arquétipos de executivo por estágio: arquiteto (constrói playbook do zero), otimizador (melhora o existente), escalador (encontra alavancagem); contratar tipo errado para estágio errado é erro fatal
...
- [[Alta Agência e Urgência — Os Dois Atributos de Contratação na OpenAI]] — vê problema e resolve sem precisar de consenso de 50 pessoas; urgência é resistência ativa à inércia institucional; cultura de Slack pesado como infraestrutura para agência descentralizada
- [[Impacto como Norte da Cultura — Outcomes sobre Atividade]] — tudo gravita ao redor de impacto: performance reviews, estratégias, reviews executivos; Zuckerberg "quando vamos ver resultados?"; impacto é vago o suficiente para cobrir qualquer trabalho e preciso o suficiente para criar accountability
- [[10X Growth Advisor — Conhecimento em Segundos]] — anos para aprender, segundos para comunicar; cliff de 3 meses, equity front-loaded, long tail de 10 anos; advisor ideal transfere conhecimento e sai — não cria dependência
...
- [[Dogfooding Mandatório — Tornar a Equipe Usuária do Produto]] — líder é usuário mais vocal; eleva quem faz dogfooding; incorpora uso do produto em offsites; "I get it" só acontece quando você usa de verdade; especialmente crítico para ferramentas de criadores
- [[Oposto do Jogo é Medo — Segurança Psicológica como Condição de Inovação]] — o oposto de jogar não é trabalhar, é ter medo; grupos de feedback entre pares quinzenais com rascunhos brutos; histórias de fracasso de líderes seniores como desbloqueador; seniores mais difíceis de fazer jogar porque aprenderam a defender posições
- [[Product Operations em Três Camadas — Escala sem Caos]] — três camadas: dados internos/insights, pesquisa de clientes, processos/cadências; habilita escala sem centralizar user research; standardize interfaces entre times e empresa, não práticas internas; 350 PMs na Athena sem bombardear mesmos clientes
- [[Product Owner como PM Incompleto — A Armadilha do Papel de Scrum]] — PO nasceu para ajudar devs a priorizar, não para fazer product management; SAFe separa PM (estratégia) de PO (execução) e o PO vira order-taker; currículo correto: valor entregue + métrica movida, não cadências ágeis
- [[SAFe como Substituto de Liderança — O Anti-Padrão Corporativo]] — executivos adotam SAFe como manual plug-and-play; ensina coordenação de times, não product management; "complexo industrial ágil" vende certificações; todo caso de sucesso com SAFe envolveu desconstruí-lo; empresa de água nos Países Baixos faliu por não conseguir fazer deploy dentro do processo
- [[Product Ops como PM dos PMs — Infraestrutura sem Poder de Decisão]] — product ops é o PM dos PMs: informa e habilita, nunca decide; PM mantém decisões, trade-offs e outcomes; NOT agile coach, NOT project manager; perfis distintos por pilar (analista, pesquisador, PM-background); comece com um
- [[Little Hands — Disposição para o Trabalho Operacional como Filtro Cultural]] — todos fazem o trabalho mais simples independente do cargo; primeira resposta deve ser "claro que faço", não "montaria um time"; contratar de empresa grande ≠ problema, mas verificar QUANDO entrou; compromisso com revenue KPIs como filtro
