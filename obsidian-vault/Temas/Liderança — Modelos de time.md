...
- [[7 Passos para Time de Developer Experience]] — inicie → quick win → dados → estratégia → venda → conduza mudança → avalie; DevEx como produto interno com PM lens
...
- [[Contrato de Papéis — Triad PM-Design-Eng-Data]] — cada membro do quartet escreve suas responsabilidades E expectativas dos outros; debate e chega a contrato explícito; cascadeado para a org
- [[PM como Facilitador de Decisão — Anti mini-CEO]] — o trabalho do PM é facilitar ritmo e qualidade da tomada de decisão, não tomar decisões; "mini-CEO" é o framing mais perigoso da história do PM; impacto resolve todos os problemas do PM
- [[Equação da Confiança — Credibilidade, Confiabilidade, Autenticidade]] — Trust = (credibilidade + confiabilidade + autenticidade) ÷ percepção de interesse próprio; credibilidade vem de insight de cliente; confiabilidade vem do say-do ratio; autenticidade vem de vulnerabilidade deliberada
- [[Acima ou Abaixo da Linha — Estado de Aprendizado vs. Vitória]] — do Conscious Leadership Group: acima da linha = comprometido com aprender (aberto, curioso, playful); abaixo da linha = comprometido com vencer/ter razão (preto e branco); reconhecer o estado é a intervenção
